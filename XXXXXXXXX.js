...
while(sc == 1){
    ...
    if(sc ==3){
        var fs = require('fs');
        fs.readFile('Desktop/Trabalho Final LP/Dadosconsulta.json', 'utf8', function readFileCallback(err,dados) {
            if (err) {
            ...
            console.log(jsonstr) 
            fs.writeFile('Desktop/Trabalho Final LP/Dadosconsulta.json', jsonstr, (err) => {
                if (err) {
